...
$understrap_builder_breadcrumbs_archive_bg = get_theme_mod( 'understrap_builder_breadcrumbs_archive_bg', '');
$understrap_builder_breadcrumbs_archive_align = get_theme_mod( 'understrap_builder_breadcrumbs_archive_align', 'left');
...
if($understrap_builder_breadcrumbs_archive_bg != ''){
  $us_b_override_bg_color = ' bg-'.$understrap_builder_breadcrumbs_archive_bg;
}

// Handle alignment
$us_b_override_alignment = '';
if($understrap_builder_breadcrumbs_archive_align != ''){
  $us_b_override_alignment = ' justify-content-'.$understrap_builder_breadcrumbs_archive_align;
}
