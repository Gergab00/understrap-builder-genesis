...
$understrap_builder_author_box_page_style = get_option( 'understrap_builder_author_box_page_style', '');
$understrap_builder_author_box_page_align = get_option( 'understrap_builder_author_box_page_align', '');
