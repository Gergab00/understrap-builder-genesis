...
/**
 * PRO Author box check for single posts.
 *
...
if($understrap_builder_override_author_box == 'hide'){
  $understrap_builder_author_box_single_style = '';
}

// Handle author box
$us_b_author_box_class = '';
if($understrap_builder_author_box_single_align != ''){
  global $post;
  $us_b_author_box_class = 'text-'.$understrap_builder_author_box_single_align;
  ...
  if(empty($us_b_display_name)){ $us_b_display_name = get_the_author_meta( 'user_nicename', $post->post_author ); }
...
if($understrap_builder_author_box_single_style == 'page-break'){ /* PRO Author Box */ ?>
...
<?php } else if($understrap_builder_author_box_single_style == 'boxed'){ ?>
<div class="us_b_author_box_boxed_single <?php echo esc_attr(understrap_builder_spacings_handler($understrap_builder_spacings_author_outer)); ?> border <?php echo esc_attr($us_b_author_box_class); ?>">
  <div class="media">
    <?php echo get_avatar( get_the_author_meta('ID'), 64, '', esc_attr($us_b_display_name).' Gravatar', array('class' => 'mr-4') ); ?>
    <div class="media-body">
      <h5><?php echo esc_attr($us_b_display_name); ?></h5>
      <div class="<?php echo esc_attr(understrap_builder_spacings_handler($understrap_builder_spacings_author_desc)); ?>">
        <?php echo esc_attr($us_b_user_description); ?>
      </div>
      <p class="<?php echo esc_attr(understrap_builder_spacings_handler($understrap_builder_spacings_author_links)); ?>">
