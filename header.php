...
} elseif (strstr($understrap_builder_navbar_bottom_border, 'shadow')) {
...
} elseif ($understrap_builder_navbar_align == 'left') {
...
<div class="site" id="page">
  ...
  <?php } ?>
    ...
    array(
      ...
      <?php } elseif ($understrap_builder_navbar_type == 'right-logo') { /* The right hand logo navbar type */ ?>
    ...
    genesis_custom_logo_setup($understrap_builder_logo_width,$understrap_builder_logo_height);
      ...
      <?php } elseif ($understrap_builder_navbar_type == 'left-logo-dual-row') { /* The left hand logo with dual right rows navbar type */ ?>
      ...
      <?php } elseif ($understrap_builder_navbar_type == 'right-logo-dual-row') { /* The right hand logo with dual left rows navbar type */ ?>
    ...
    genesis_custom_logo_setup($understrap_builder_logo_width,$understrap_builder_logo_height);
      ...
      <?php } elseif ($understrap_builder_navbar_type == 'center-logo-inside') { /* The center logo with inside aligned menus type */ ?>
    ...
    array(
        ...
        'walker' => new Understrap_WP_Bootstrap_Navwalker(),
            ...
            <div class="navbar-collapse collapse w-25 order-2 dual-collapse2">
              ...
              <?php } ?>
              <div class="social d-none d-lg-inline ml-auto">
			          <?php echo skyrocket_get_social_media(); ?>
		          </div>
            </div>
      ...
      <?php } elseif ($understrap_builder_navbar_type == 'center-logo-outside') { /* The center logo with outside aligned menus type */ ?>
    ...
    array(
      ...
      <?php } elseif ($understrap_builder_navbar_type == 'center-logo-below') { /* The center logo with main menu below */ ?>
    ...
    array(
      ...
      <?php } elseif ($understrap_builder_submenu_type == 'right') { /* The right hand submenu type */ ?>
    ...
    array(
      ...
      <?php } elseif ($understrap_builder_submenu_type == 'center') { /* The center aligned submenu type */ ?>
