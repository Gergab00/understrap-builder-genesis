...
$understrap_builder_traker_search_show = 1;//get_theme_mod( 'understrap_builder_traker_search_show', 'enabled');// Tracker bar search
    ...
    <div class="site" id="page">
        ...
        <div id="us_b_navbar_hero_wrap" class="<?php echo esc_attr($understrap_builder_hero_bg_class); ?>">
            ...
            <div id="wrapper-navbar" itemscope itemtype="http://schema.org/WebSite"
                class="wrapper-navbar<?php echo esc_attr($us_b_wrapper_nav_class); ?>">

                <div id="us_b_navbar_border_shadow"
                    class="position-relative <?php echo esc_attr($us_b_navbar_border_shadow_class); ?>">

                    <a class="skip-link sr-only sr-only-focusable"
                        href="#content"><?php esc_html_e( 'Skip to content', 'understrap-builder' ); ?></a>

                    <?php if($understrap_builder_submenu_type == 'left'){ /* ============== SUBMENUS ================ The left hand submenu type */  ?>

                    <nav
                        class="navbar <?php echo esc_attr($understrap_builder_submenu_classes); ?> <?php echo esc_attr(understrap_builder_spacings_handler($understrap_builder_spacings_navbar_submenu)); ?> <?php echo esc_attr($understrap_builder_submenu_color_scheme); ?> <?php echo esc_attr($us_b_submenu_background_class); ?> p-0 us_b_submenu submenu_left">

                        <div class="<?php echo esc_attr($understrap_builder_container_type, 'understrap-builder'); ?>">

                        <div class="skew-right bg-primary">
      ...
      array(
        ...
        'walker'          => new Understrap_WP_Bootstrap_Navwalker(),
                        ...
                        <?php if($understrap_builder_traker_search_show == 1){ // Tracker search place?>
                        <form
                            class="form-inline ml-3 d-block d-<?php echo esc_attr($understrap_builder_mobile_navbar_breakpoint); ?>-block frame-386"
                            _lpchecked="1" action="<?php echo esc_url(home_url('/')); ?>" method="get" id="us_b_search">
                            <div class="input-group mb-3 skew-right">
                                <input class="form-control union" type="text"
                                    placeholder="<?php esc_attr_e( 'Track a package', 'understrap' ); ?>"
                                    aria-label="<?php esc_attr_e( 'Track a package', 'understrap' ); ?>" name="s" />
                                <button type="submit" class="btn btn-color-1"><i class="fas fa-search"></i></button>
                            </div>
                        </form>
                        <?php } ?>
                        </div>
                    ...
                    <nav
                        class="navbar <?php echo esc_attr($understrap_builder_submenu_classes); ?> <?php echo esc_attr(understrap_builder_spacings_handler($understrap_builder_spacings_navbar_submenu)); ?> <?php echo esc_attr($understrap_builder_submenu_color_scheme); ?> <?php echo esc_attr($us_b_submenu_background_class); ?> p-0 us_b_submenu submenu_right">
      ...
      array(
        ...
        'walker'          => new Understrap_WP_Bootstrap_Navwalker(),
                    ...
                    <nav
                        class="navbar <?php echo esc_attr($understrap_builder_submenu_classes); ?> <?php echo esc_attr(understrap_builder_spacings_handler($understrap_builder_spacings_navbar_submenu)); ?> <?php echo esc_attr($understrap_builder_submenu_color_scheme); ?> <?php echo esc_attr($us_b_submenu_background_class); ?> p-0 us_b_submenu d-flex">
                        <!-- d-flex justify-content-evenly -->
                        <div class="d-flex align-items-stretch skew-right bg-primary">
                        <span class="navbar-brand mx-auto">
                        <a class="navbar-brand" href="#">SHIP WITH RPM NOW</a>
                        </span>
                        </div>
                        <div class="collapse navbar-collapse mx-5 <?php echo esc_attr($understrap_builder_container_type, 'understrap-builder'); ?>">
      ...
      array(
        ...
        'container_id'    => 'navbarNavDropdownSubmenu',
        'menu_class'      => 'navbar-nav align-items-start'.$us_b_submenu_link_width_menu_class_add,
        'fallback_cb'     => '',
        'menu_id'         => 'main-menu',
        'depth'           => 2,
        'walker'          => new Understrap_WP_Bootstrap_Navwalker(),
                        ...
                        <?php if($understrap_builder_traker_search_show == 1){ // Tracker search place?>
                          <form
                            class="form-inline ml-3 mx-auto d-block d-<?php echo esc_attr($understrap_builder_mobile_navbar_breakpoint); ?>-block frame-386"
                            _lpchecked="1" action="<?php echo esc_url(home_url('/')); ?>" method="get" id="us_b_search">
                            <div class="input-group mb-3 skew-right">
                                <input class="form-control union" type="text"
                                    placeholder="<?php esc_attr_e( 'Track a package', 'understrap' ); ?>"
                    ...
                    <nav
                        class="navbar navbar-expand-<?php echo esc_attr($understrap_builder_mobile_navbar_breakpoint); ?> <?php echo esc_attr(understrap_builder_spacings_handler($understrap_builder_spacings_navbar)); ?> <?php echo esc_attr($understrap_builder_navbar_color_scheme); ?> <?php echo esc_attr($us_b_navbar_background_class); ?> us_b_main_menu main_menu_left">
                        ...
                        <div class="<?php echo esc_attr($understrap_builder_container_type, 'understrap-builder'); ?>">
                            ...
                            <h1
                                class="navbar-brand <?php echo esc_attr(understrap_builder_spacings_handler($understrap_builder_spacings_navbar_logo)); ?>">
                            ...
                            <a class="navbar-brand <?php echo esc_attr(understrap_builder_spacings_handler($understrap_builder_spacings_navbar_logo)); ?>"
               ...
               genesis_custom_logo_setup($understrap_builder_logo_width,$understrap_builder_logo_height);
                            ...
                            <button class="navbar-toggler understrap_builder_navbar_toggler collapsed" type="button"
                                ...
                                aria-label="<?php esc_attr_e( 'Toggle navigation', 'understrap-builder' ); ?>">
                ...
                array(
                  ...
                  'walker'          => new Understrap_WP_Bootstrap_Navwalker(),
                            ...
                            <a href="<?php echo esc_attr($understrap_builder_navbar_cta_url); ?>"
                                class="btn btn-<?php echo esc_attr($understrap_builder_navbar_cta_bg); ?> ml-3 d-none d-<?php echo esc_attr($understrap_builder_mobile_navbar_breakpoint); ?>-inline px-3 py-2<?php if($understrap_builder_navbar_search_show == 1){ echo ' mr-3'; } ?>"
                                id="us_b_navbar_cta">
                            ...
                            <form
                                class="form-inline ml-3 d-none d-<?php echo esc_attr($understrap_builder_mobile_navbar_breakpoint); ?>-inline"
                                _lpchecked="1" action="<?php echo esc_url(home_url('/')); ?>" method="get"
                                id="us_b_search">
                                <input class="form-control" type="text"
                                    placeholder="<?php esc_attr_e( 'Search', 'understrap' ); ?>"
                                    aria-label="<?php esc_attr_e( 'Search', 'understrap' ); ?>" name="s" />
                            </form>
                            <?php } ?>
                    ...
                    <?php echo esc_attr($us_b_navbar_border_shadow_class); ?> us_b_main_menu main_menu_right">
                        ...
                        <div class="<?php echo esc_attr($understrap_builder_container_type, 'understrap-builder'); ?>">
                            ...
                            <?php if($understrap_builder_navbar_search_show == 1){ ?>
                            <form
                                class="form-inline mr-3 d-none d-<?php echo esc_attr($understrap_builder_mobile_navbar_breakpoint); ?>-inline"
                                _lpchecked="1" action="<?php echo esc_url(home_url('/')); ?>" method="get"
                                id="us_b_search">
                                <input class="form-control" type="text"
                                    placeholder="<?php esc_attr_e( 'Search', 'understrap' ); ?>"
                            ...
                            <?php if($understrap_builder_navbar_cta_show != 0){ ?>
                            <a href="<?php echo esc_attr($understrap_builder_navbar_cta_url); ?>"
                                class="btn btn-<?php echo esc_attr($understrap_builder_navbar_cta_bg); ?> mr-3 d-none d-<?php echo esc_attr($understrap_builder_mobile_navbar_breakpoint); ?>-inline px-3 py-2"
                                id="us_b_navbar_cta">
               ...
               genesis_custom_logo_setup($understrap_builder_logo_width,$understrap_builder_logo_height);
                    ...
                    <nav
                        class="navbar navbar-expand-<?php echo esc_attr($understrap_builder_mobile_navbar_breakpoint); ?> <?php echo esc_attr(understrap_builder_spacings_handler($understrap_builder_spacings_navbar)); ?> <?php echo esc_attr($understrap_builder_navbar_color_scheme); ?> <?php echo esc_attr($us_b_navbar_background_class); ?> us_b_main_menu main_menu_left_dual_row">
                            ...
                            <div class="flex-column">
                                ...
                                <div class="flex-row us_b_dual_row_1 mt-3 text-right">
                                    ...
                                    <a href="<?php echo esc_attr($understrap_builder_navbar_cta_url); ?>"
                                        ...
                                        <?php if($understrap_builder_navbar_cta_fa_icon_side == 'left'){ ?>
                                        <i
                                            class="<?php echo esc_attr($understrap_builder_navbar_cta_fa_icon_string); ?>"></i>
                                        <?php } ?>
                                ...
                                <div
                                    class="flex-row us_b_dual_row_1 mt-3 text-right text-<?php echo esc_attr($understrap_builder_mobile_navbar_breakpoint); ?>-left">

                                    <?php if(($us_b_locations = get_nav_menu_locations()) && $us_b_locations['primary'] != 0) { ?>

                                    <button class="navbar-toggler understrap_builder_navbar_toggler collapsed"
                        ...
                        <div class="<?php echo esc_attr($understrap_builder_container_type, 'understrap-builder'); ?>">
                            ...
                            <div class="flex-column">
                                ...
                                <div class="flex-row us_b_dual_row_1 mt-3">
                                    ...
                                    <?php if($understrap_builder_navbar_search_show == 1){ ?>
                                    <form
                                        class="form-inline mr-3 ml-2 d-none d-<?php echo esc_attr($understrap_builder_mobile_navbar_breakpoint); ?>-inline"
                                        _lpchecked="1" action="<?php echo esc_url(home_url('/')); ?>" method="get"
                                        id="us_b_search">
                                        <input class="form-control" type="text"
                                            placeholder="<?php esc_attr_e( 'Search', 'understrap' ); ?>"
                                    ...
                                    <?php if($understrap_builder_navbar_cta_show != 0){ ?>
                                    <a href="<?php echo esc_attr($understrap_builder_navbar_cta_url); ?>"
                                        class="btn btn-<?php echo esc_attr($understrap_builder_navbar_cta_bg); ?> ml-2 mr-3 d-none d-<?php echo esc_attr($understrap_builder_mobile_navbar_breakpoint); ?>-inline px-3 py-2"
                                        id="us_b_navbar_cta">
               ...
               genesis_custom_logo_setup($understrap_builder_logo_width,$understrap_builder_logo_height);
                    ...
                    <?php echo esc_attr($us_b_navbar_border_shadow_class); ?> us_b_main_menu main_menu_center_inside">
                        ...
                        <div class="<?php echo esc_attr($understrap_builder_container_type, 'understrap-builder'); ?>">
                            ...
                            <div class="navbar-collapse collapse w-25 order-2 order-<?php echo esc_attr($understrap_builder_mobile_navbar_breakpoint); ?>-0"
                  ...
                  array(
                    ...
                    'walker'          => new Understrap_WP_Bootstrap_Navwalker(),
                            ...
                            <div class="navbar-collapse collapse w-25 order-2 dual-collapse2">
                                ...
                                <?php if($understrap_builder_navbar_cta_show != 0){ ?>
                                <a href="<?php echo esc_attr($understrap_builder_navbar_cta_url); ?>"
                                    class="btn btn-<?php echo esc_attr($understrap_builder_navbar_cta_bg); ?> ml-auto d-none d-lg-inline px-3 py-2<?php if($understrap_builder_navbar_search_show == 1){ echo ' mr-3'; } ?>"
                                    id="us_b_navbar_cta">
                                ...
                                <?php } ?>
                                <?php if($understrap_builder_navbar_search_show == 1){ ?>
                                <form class="form-inline d-none d-lg-inline ml-auto" _lpchecked="1"
                                    action="<?php echo esc_url(home_url('/')); ?>" method="get" id="us_b_search">
                                    <input class="form-control" type="text"
                                        placeholder="<?php esc_attr_e( 'Search', 'understrap' ); ?>"
                                        aria-label="<?php esc_attr_e( 'Search', 'understrap' ); ?>" name="s" />
                                </form>
                    ...
                    <?php echo esc_attr($us_b_navbar_border_shadow_class); ?> us_b_main_menu main_menu_center_outside">
                        ...
                        <div class="<?php echo esc_attr($understrap_builder_container_type, 'understrap-builder'); ?>">
                            ...
                            <div class="navbar-collapse collapse w-100 order-2 order-<?php echo esc_attr($understrap_builder_mobile_navbar_breakpoint); ?>-0 dual-collapse2"
                                id="navbarNavDropdown">
                                <?php wp_nav_menu(
                  array(
                    'theme_location'  => 'primary',
                  ...
                  array(
                    ...
                    'walker'          => new Understrap_WP_Bootstrap_Navwalker(),
                                ...
                                <?php if($understrap_builder_navbar_cta_show != 0){ ?>
                                <a href="<?php echo esc_attr($understrap_builder_navbar_cta_url); ?>"
                                    class="btn btn-<?php echo esc_attr($understrap_builder_navbar_cta_bg); ?> ml-auto d-none d-lg-inline px-3 py-2 mr-3"
                                    id="us_b_navbar_cta">
                    ...
                    <?php echo esc_attr($us_b_navbar_background_class); ?> us_b_main_menu main_menu_center_below_top">
                        ...
                        <div class="<?php echo esc_attr($understrap_builder_container_type, 'understrap-builder'); ?>">
                            ...
                            <div
                                class="order-0 w-25 d-none d-<?php echo esc_attr($understrap_builder_mobile_navbar_breakpoint); ?>-flex">
                            </div>
                    ...
                    <nav
                        class="navbar navbar-expand-<?php echo esc_attr($understrap_builder_mobile_navbar_breakpoint); ?> <?php echo esc_attr(understrap_builder_spacings_handler($understrap_builder_spacings_navbar)); ?> <?php echo esc_attr($understrap_builder_navbar_color_scheme); ?> <?php echo esc_attr($us_b_navbar_background_class); ?> 
                  ...
                  array(
                    ...
                    <?php if(is_customize_preview()){ ?>
                    <div class="text-center">
                        <div class="alert alert-danger mt-2 text-center d-inline-block" role="alert"
