...
function check_display_onpage_styles(){
  ...
  if($understrap_builder_bs_color_default != 'default'){
    ...
    foreach($us_b_potential_bootstrap_color_classes as $bs_color => $bs_color_default){
      ...
      $styles_to_display .= '.btn-outline-'.$bs_color_lower.'{color:'.$understrap_builder_bs_color_default.'!important;border-color:'.$understrap_builder_bs_color_default.'!important}';
  ...
  // Navbar dropdowns
  $understrap_builder_navbar_dropdown_border_on = get_theme_mod( 'understrap_builder_navbar_dropdown_border_on', 1 );
  if($understrap_builder_navbar_dropdown_border_on == 0){
    $styles_to_display .= '.dropdown-menu{border:none!important}'; 
  }
  $understrap_builder_navbar_dropdown_border_radius = get_theme_mod( 'understrap_builder_navbar_dropdown_border_radius', 5 );
  $styles_to_display .= '.dropdown-menu{border-radius:'.esc_attr($understrap_builder_navbar_dropdown_border_radius).'px!important}'; 
  
  $understrap_builder_navbar_dropdown_bg = get_theme_mod( 'understrap_builder_navbar_dropdown_bg', '' );
  if($understrap_builder_navbar_dropdown_bg == 'custom'){
    $understrap_builder_navbar_dropdown_custom_bg = get_theme_mod( 'understrap_builder_navbar_dropdown_custom_bg', '' );
  ...
  $understrap_builder_navbar_dropdown_border = get_theme_mod( 'understrap_builder_navbar_dropdown_border', '' );
  if($understrap_builder_navbar_dropdown_border == 'custom'){
    $understrap_builder_navbar_dropdown_custom_border = get_theme_mod( 'understrap_builder_navbar_dropdown_custom_border', '' );
  ...
  $understrap_builder_navbar_dropdown_link = get_theme_mod( 'understrap_builder_navbar_dropdown_link', '' );
  if($understrap_builder_navbar_dropdown_link == 'custom'){
    $understrap_builder_navbar_dropdown_custom_link = get_theme_mod( 'understrap_builder_navbar_dropdown_custom_link', '' );
  ...
  $understrap_builder_navbar_dropdown_link_hover = get_theme_mod( 'understrap_builder_navbar_dropdown_link_hover', '' );
  if($understrap_builder_navbar_dropdown_link_hover == 'custom'){
    $understrap_builder_navbar_dropdown_custom_link_hover = get_theme_mod( 'understrap_builder_navbar_dropdown_custom_link_hover', '' );
  ...
  $understrap_builder_navbar_dropdown_bg_hover = get_theme_mod( 'understrap_builder_navbar_dropdown_bg_hover', '' );
  if($understrap_builder_navbar_dropdown_bg_hover == 'custom'){
    $understrap_builder_navbar_dropdown_custom_bg_hover = get_theme_mod( 'understrap_builder_navbar_dropdown_custom_bg_hover', '' );
